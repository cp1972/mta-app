...
## MTA does
 ...
 - Cross validation metrics for topic model analysis based on clustering algorithms (kmeans++, BERT [droped in new version]) aiming at guessing the best number of topics for a particular corpus
